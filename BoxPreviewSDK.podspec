#
#  Be sure to run `pod spec lint BoxPreviewSDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Sujay Garlanka"
  # spec.authors            = { "Sujay Garlanka" => "sujay.garlanka@gmail.com" }
